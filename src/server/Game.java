...
public class Game {
    ...
    // Ermittlung Gewinner einer Runde (4Karten/Züge)
    ...
    // Setzt alle Karten des Spielers der am Zug ist auf spielbar
    ...
    // Setzt alle Karten eines Spielers auf nicht spielbar, wenn er nicht am Zug ist
	...
	String result;
	if (team1.getTeam_id() == this.lastWinnerTeam_ID) {
	    result = team1.getTeamNames();
	}
	else
	    result = team2.getTeamNames();
	return result;
    }
}
