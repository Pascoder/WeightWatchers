...
public enum CardRank {
	Six(1, 1, 0, 0, 11), Seven(2, 2, 0, 0, 11), Eight(3, 3, 0, 0, 8), Nine(4, 8, 0, 14, 0), Ten(5, 4, 10, 10, 10),
	Jack(6, 9, 2, 20, 2), Queen(7, 5, 3, 3, 3), King(8, 6, 4, 4, 4), Ace(9, 7, 11, 11, 0);
...
//Konstruktor 2
	...
	public String toString() {
		/*
		 * Alle Karten mit einem Zahlenwert werden mit Integer.toString in einen String
		 * wert umgewandelt Six waere also ordinal 0, also +6 = String -->6
		 */
		String cardRank = "Ace";
