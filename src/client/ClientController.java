...
public class ClientController {
	...
	// TODO model, view waere besser nicht statisch gewesen
	...
	public ClientController(ClientModel clientModel, ClientView clientView) {
		...
		// Wenn kein Spiel selektiert ist kann auch nicht der LeaveGameButton geklickt
		// werden
		...
		// Wenn kein Game getippt wurde im TextFeld kann CreatGameButton nicht geklickt
		// werden
		lobbyview.getCreateGameButton().disableProperty().bind(lobbyview.getTextField().textProperty().isEmpty());
		// Spieler klickt Quit in Lobby und verl�sst das komplette Spiel
		...
		// Bereits selektiertes Game wird aus SelectedGames gel�scht
		...
		// Game wird mit doppelklick in ListView geJoint und zu Selectedgames
		// hinzugef�gt
		...
		// Leave Game Button wird in Game gedr�ckt
		...
		// Quit Button wird in Game gedr�ckt
