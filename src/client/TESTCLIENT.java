...
public class TESTCLIENT extends Application{
	 ...
	 private static TESTCLIENT mainProgram; // singletonfrank
		private ClientModel clientModel;
		private TESTCLIENTVIEW clientView;
	...
	public static void main(String[] args) {
	 ...
	 @Override
	    ...
	    public void start(Stage stage) {
			...
			this.clientView = new TESTCLIENTVIEW(stage, clientModel);
			this.clientController = new TESTCLIENTCONTROLLER(clientModel, clientView);
...
//			this.tc = new Test_Controller(clientModel, tv);
	    ...
	    protected static TESTCLIENT getMainProgram() {
	        return mainProgram;
	    }
